...
from network import runSimulation, getPipeCost, getPressure, MRI

class WaterNetworkProblem(ElementwiseProblem):

    def __init__(self, wn, min_pressure, max_pressure, resilience_target):
        self.wn = wn
...
def optimize_water_network(wn, threshold, max_pressure, resilience_target):
    water_network_problem = WaterNetworkProblem(wn, threshold, max_pressure, resilience_target)
